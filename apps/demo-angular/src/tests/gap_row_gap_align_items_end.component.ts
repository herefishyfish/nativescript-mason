...
@Component({
  ...
  template: `
    <ActionBar title="gap_row_gap_align_items_end"></ActionBar>
    <TSCView id="test-root" style="flex-direction: row; flex-wrap: wrap; width: 100dip; height: 200dip; column-gap: 10dip; row-gap: 20dip; align-items:flex-end;" testID="test-root" backgroundColor="red">
...
export class GapRowGapAlignItemsEndComponent {}
