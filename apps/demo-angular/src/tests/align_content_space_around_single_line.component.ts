...
@Component({
  ...
  template: `
    <ActionBar title="align_content_space_around_single_line"></ActionBar>
    <TSCView id="test-root" style="width: 100dip; height: 100dip; flex-direction: row; align-content: space-around;" testID="test-root" backgroundColor="red">
...
export class AlignContentSpaceAroundSingleLineComponent {}
