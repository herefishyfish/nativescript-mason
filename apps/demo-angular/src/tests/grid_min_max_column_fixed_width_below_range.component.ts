...
@Component({
  ...
  template: `
    <ActionBar title="grid_min_max_column_fixed_width_below_range"></ActionBar>
    <TSCView id="test-root" style="width: 90dip; display: grid; grid-template-columns: 40dip minmax(20dip, 40dip) 40dip;grid-template-rows: 40dip 40dip 40dip;" testID="test-root" backgroundColor="red">
...
export class GridMinMaxColumnFixedWidthBelowRangeComponent {}
