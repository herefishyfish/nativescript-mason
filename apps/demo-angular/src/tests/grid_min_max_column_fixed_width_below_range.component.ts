...
@Component({
  ...
  <TSCView id="test-root" style="width: 90dip; display: grid; grid-template-columns: 40dip minmax(20dip, 40dip) 40dip;grid-template-rows: 40dip 40dip 40dip;" backgroundColor="red">
