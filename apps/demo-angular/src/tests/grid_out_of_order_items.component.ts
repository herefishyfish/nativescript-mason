...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="height: 120dip; width: 120dip; display: grid; grid-template-columns: 40dip 40dip 40dip;grid-template-rows: 40dip 40dip 40dip;grid-auto-flow: row dense;" testID="test-root" backgroundColor="red">
