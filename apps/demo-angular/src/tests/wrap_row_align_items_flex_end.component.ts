...
@Component({
  ...
  template: `
    <ActionBar title="wrap_row_align_items_flex_end"></ActionBar>
    <TSCView id="test-root" style="width: 100dip; flex-direction: row; flex-wrap: wrap; align-items: flex-end;" testID="test-root" backgroundColor="red">
...
export class WrapRowAlignItemsFlexEndComponent {}
