...
@Component({
  ...
  template: `
    <ActionBar title="grid_max_content_maximum_single_item"></ActionBar>
    <TSCView id="test-root" style="display: grid; grid-template-columns: 40dip minmax(0dip, max-content) 40dip;grid-template-rows: 40dip 40dip 40dip" testID="test-root" backgroundColor="red">
...
export class GridMaxContentMaximumSingleItemComponent {}
