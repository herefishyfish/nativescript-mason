...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="flex-direction: row; width: 100dip; height: 100dip; column-gap: 10%; row-gap: 20dip;padding: 10dip" testID="test-root" backgroundColor="red">
