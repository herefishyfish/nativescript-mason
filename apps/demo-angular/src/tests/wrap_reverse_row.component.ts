...
@Component({
  ...
  template: `
    <ActionBar title="wrap_reverse_row"></ActionBar>
    <TSCView id="test-root" style="width: 100dip; flex-direction: row; flex-wrap: wrap-reverse" testID="test-root" backgroundColor="red">
...
export class WrapReverseRowComponent {}
