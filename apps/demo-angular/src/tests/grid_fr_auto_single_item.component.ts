...
@Component({
  ...
  template: `
    <ActionBar title="grid_fr_auto_single_item"></ActionBar>
    <TSCView id="test-root" style="width: auto;height: auto;display: grid; grid-template-columns: 40dip 1fr 1fr;grid-template-rows: 40dip 1fr 1fr" testID="test-root" backgroundColor="red">
...
export class GridFrAutoSingleItemComponent {}
