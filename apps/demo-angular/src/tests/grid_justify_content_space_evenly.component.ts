...
@Component({
  ...
  template: `
    <ActionBar title="grid_justify_content_space_evenly"></ActionBar>
    <TSCView id="test-root" style="height: 200dip; width: 200dip; display: grid; grid-template-columns: 40dip 40dip 40dip;grid-template-rows: 40dip 40dip 40dip;justify-content: space-evenly;" testID="test-root" backgroundColor="red">
...
export class GridJustifyContentSpaceEvenlyComponent {}
