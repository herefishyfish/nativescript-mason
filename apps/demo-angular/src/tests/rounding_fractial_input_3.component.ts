...
@Component({
  ...
  template: `
  <ActionBar title="rounding_fractial_input_3"></ActionBar>
  <TSCView id="test-root" style="height: 113.4dip; width: 100dip; flex-direction: column;" backgroundColor="red">
...
export class RoundingFractialInput_3Component {}
