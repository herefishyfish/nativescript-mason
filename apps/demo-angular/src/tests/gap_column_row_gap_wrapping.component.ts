...
@Component({
  ...
  template: `
    <ActionBar title="gap_column_row_gap_wrapping"></ActionBar>
    <TSCView id="test-root" style="flex-direction: row; flex-wrap: wrap; width: 80dip; column-gap: 10dip; row-gap: 20dip;" testID="test-root" backgroundColor="red">
...
export class GapColumnRowGapWrappingComponent {}
