...
@Component({
  ...
  template: `
    <ActionBar title="grid_align_content_space_between"></ActionBar>
    <TSCView id="test-root" style="height: 200dip; width: 200dip; display: grid; grid-template-columns: 40dip 40dip 40dip;grid-template-rows: 40dip 40dip 40dip;align-content: space-between;" testID="test-root" backgroundColor="red">
...
export class GridAlignContentSpaceBetweenComponent {}
