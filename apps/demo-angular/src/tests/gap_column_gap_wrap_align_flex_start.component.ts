...
@Component({
  ...
  template: `
    <ActionBar title="gap_column_gap_wrap_align_flex_start"></ActionBar>
    <TSCView id="test-root" style="flex-direction: row; flex-wrap: wrap; align-content: flex-start; width: 100dip; height: 100dip; column-gap: 10dip; row-gap: 20dip;" testID="test-root" backgroundColor="red">
...
export class GapColumnGapWrapAlignFlexStartComponent {}
