...
@Component({
  ...
  template: `
    <ActionBar title="width_smaller_then_content_with_flex_grow_very_large_size"></ActionBar>
...
export class WidthSmallerThenContentWithFlexGrowVeryLargeSizeComponent {}
