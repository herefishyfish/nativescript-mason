...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="flex-direction: row; flex-wrap: wrap; align-content: space-around; width: 100dip; height: 100dip; column-gap: 10dip; row-gap: 20dip;" testID="test-root" backgroundColor="red">
