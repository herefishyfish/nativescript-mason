...
@Component({
  ...
  template: `
    <ActionBar title="flex_basis_smaller_then_content_with_flex_grow_unconstraint_size"></ActionBar>
    <TSCView id="test-root" style="flex-direction: row;" testID="test-root" backgroundColor="red">
...
export class FlexBasisSmallerThenContentWithFlexGrowUnconstraintSizeComponent {}
