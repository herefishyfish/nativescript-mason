...
@Component({
  ...
  template: `
    <ActionBar title="wrap_reverse_row_align_content_stretch"></ActionBar>
    <TSCView id="test-root" style="width: 100dip; flex-direction: row; flex-wrap: wrap-reverse; align-content: stretch;" testID="test-root" backgroundColor="red">
...
export class WrapReverseRowAlignContentStretchComponent {}
