...
@Component({
  ...
  template: `
    <ActionBar title="wrap_reverse_row_align_content_center"></ActionBar>
    <TSCView id="test-root" style="width: 100dip; flex-direction: row; flex-wrap: wrap-reverse; align-content: center;" testID="test-root" backgroundColor="red">
...
export class WrapReverseRowAlignContentCenterComponent {}
