...
@Component({
  ...
  template: `
    <ActionBar title="grid_absolute_container_bottom_left_margin"></ActionBar>
...
export class GridAbsoluteContainerBottomLeftMarginComponent {}
