...
@Component({
  ...
  template: `
    <ActionBar title="flex_basis_smaller_then_content_with_flex_grow_very_large_size"></ActionBar>
    <TSCView id="test-root" flexDirection="row" style="flex-direction: row; width: 200dip;" backgroundColor="red">
...
export class FlexBasisSmallerThenContentWithFlexGrowVeryLargeSizeComponent {}
