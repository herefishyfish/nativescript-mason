...
@Component({
  ...
  <TSCView id="test-root" style="flex-direction: row; flex-wrap: wrap; align-content: center; width: 100dip; height: 100dip; column-gap: 10dip; row-gap: 20dip;" backgroundColor="red">
