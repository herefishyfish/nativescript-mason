...
@Component({
  ...
  template: `
    <ActionBar title="grid_gap"></ActionBar>
    <TSCView id="test-root" style="height: 200dip; width: 200dip; display: grid; grid-template-columns: 40dip 40dip 40dip;grid-template-rows: 40dip 40dip 40dip;gap: 40dip 40dip" testID="test-root" backgroundColor="red">
