...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="flex-direction: row; flex-wrap: wrap; width: 100dip; height: 200dip; column-gap: 10dip; row-gap: 20dip; align-items:stretch; align-content: stretch" testID="test-root" backgroundColor="red">
