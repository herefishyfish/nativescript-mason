...
@Component({
  ...
  template: `
    <ActionBar title="gap_column_gap_wrap_align_flex_end"></ActionBar>
    <TSCView id="test-root" style="flex-direction: row; flex-wrap: wrap; align-content: flex-end; width: 100dip; height: 100dip; column-gap: 10dip; row-gap: 20dip;" testID="test-root" backgroundColor="red">
...
export class GapColumnGapWrapAlignFlexEndComponent {}
