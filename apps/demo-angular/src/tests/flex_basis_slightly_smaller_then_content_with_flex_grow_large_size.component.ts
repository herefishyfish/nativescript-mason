...
@Component({
  ...
  template: `
  <ActionBar title="flex_basis_slightly_smaller_then_content_with_flex_grow_large_size"></ActionBar>
  <TSCView id="test-root" style="flex-direction: row; width: 100dip;" backgroundColor="red">
  <TSCView style="flex-basis: 60dip; flex-grow: 1; flex-direction: column;" backgroundColor="green">
...
export class FlexBasisSlightlySmallerThenContentWithFlexGrowLargeSizeComponent {}
