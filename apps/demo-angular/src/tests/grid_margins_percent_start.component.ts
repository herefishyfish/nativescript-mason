...
@Component({
  ...
  template: `
  <ActionBar title="grid_margins_percent_start"></ActionBar>
  ...
  <TSCView style="height:20dip;width:20dip;margin: 5% 10% 15% 20%;align-self:start;justify-self:start;" backgroundColor="green"></TSCView>
...
export class GridMarginsPercentStartComponent {}
