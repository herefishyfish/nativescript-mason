...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="flex-direction: row; justify-content: flex-start; width: 100dip; height: 100dip; column-gap: 10dip;" testID="test-root" backgroundColor="red">
