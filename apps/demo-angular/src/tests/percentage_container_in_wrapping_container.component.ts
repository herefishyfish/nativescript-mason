...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="align-items: center; width: 200dip; height: 200dip; justify-content: center; flex-direction: column;" testID="test-root" backgroundColor="red">
