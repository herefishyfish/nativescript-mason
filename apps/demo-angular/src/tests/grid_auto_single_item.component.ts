...
@Component({
  ...
  template: `
    <ActionBar title="grid_auto_single_item"></ActionBar>
    <TSCView id="test-root" style="display: grid; grid-template-columns: 40dip auto 40dip;grid-template-rows: 40dip 40dip 40dip" testID="test-root" backgroundColor="red">
...
export class GridAutoSingleItemComponent {}
