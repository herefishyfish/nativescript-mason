...
@Component({
  ...
  template: `
  <ActionBar title="grid_min_content_flex_single_item_margin_fixed"></ActionBar>
  ...
  <TSCView style="min-width: 10dip;margin: 5dip 10dip 15dip 20dip" backgroundColor="blue"></TSCView>
  <TSCView backgroundColor="yellow"></TSCView>
  <TSCView backgroundColor="purple"></TSCView>
  <Label style="grid-column: span 2;margin: 5dip 10dip 15dip 20dip" backgroundColor="cyan">HH​HH</Label>
...
export class GridMinContentFlexSingleItemMarginFixedComponent {}
