...
@Component({
  ...
  <TSCView id="test-root" style="width: 200dip;height:200dip;display: grid; grid-template-columns: 40dip auto 40dip auto;grid-template-rows: 40dip auto 40dip auto;" backgroundColor="red">
