...
@Component({
  ...
  template: `
  <ActionBar title="align_items_flex_end_child_with_margin_bigger_than_parent"></ActionBar>
...
export class AlignItemsFlexEndChildWithMarginBiggerThanParentComponent {}
