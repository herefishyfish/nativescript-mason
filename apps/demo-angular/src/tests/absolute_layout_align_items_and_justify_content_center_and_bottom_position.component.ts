...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="height: 100dip; width: 110dip; align-items: center; justify-content: center;" backgroundColor="red">
      <TSCView style="position: absolute; width: 60dip; height: 40dip;bottom:10dip;" backgroundColor="green"></TSCView>
    </TSCView>
  `,
})
export class AbsoluteLayoutAlignItemsAndJustifyContentCenterAndBottomPositionComponent {}
