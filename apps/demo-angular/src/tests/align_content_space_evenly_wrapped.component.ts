...
@Component({
  ...
  template: `
    <ActionBar title="align_content_space_evenly_wrapped"></ActionBar>
    <TSCView id="test-root" style="width: 100dip; height: 100dip; flex-direction: row; flex-wrap: wrap; align-content: space-evenly;" testID="test-root" backgroundColor="red">
...
export class AlignContentSpaceEvenlyWrappedComponent {}
