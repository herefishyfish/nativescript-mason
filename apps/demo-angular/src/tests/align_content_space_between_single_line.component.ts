...
@Component({
  ...
  template: `
    <ActionBar title="align_content_space_between_single_line"></ActionBar>
    <TSCView id="test-root" style="width: 100dip; height: 100dip; flex-direction: row; align-content: space-between;" testID="test-root" backgroundColor="red">
...
export class AlignContentSpaceBetweenSingleLineComponent {}
