...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="height: 200dip; width: 200dip; display: grid; grid-template-columns: 40dip 40dip 40dip;grid-template-rows: 40dip 40dip 40dip;align-content: end;padding: 10dip 20dip 30dip 40dip;border-width: 2dip 4dip 6dip 8dip;" testID="test-root" backgroundColor="red">
