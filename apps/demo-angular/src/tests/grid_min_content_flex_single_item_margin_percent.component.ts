...
@Component({
  ...
  template: `
    <ActionBar title="grid_min_content_flex_single_item_margin_percent"></ActionBar>
    <TSCView id="test-root" style="display: grid; grid-template-columns: 40dip min-content 1fr;grid-template-rows: 40dip 40dip 40dip" testID="test-root" backgroundColor="red">
      ...
      <TSCView style="min-width: 10dip;margin: 5% 10% 15% 20%" backgroundColor="blue"></TSCView>
      <TSCView backgroundColor="yellow"></TSCView>
      <TSCView backgroundColor="purple"></TSCView>
      <Label style="grid-column: span 2;margin: 5% 10% 15% 20%" backgroundColor="cyan">HH​HH</Label>
...
export class GridMinContentFlexSingleItemMarginPercentComponent {}
