...
@Component({
  ...
  template: `
    <ActionBar title="grid_min_content_single_item"></ActionBar>
    <TSCView id="test-root" style="display: grid; grid-template-columns: 40dip min-content 40dip;grid-template-rows: 40dip 40dip 40dip" testID="test-root" backgroundColor="red">
...
export class GridMinContentSingleItemComponent {}
