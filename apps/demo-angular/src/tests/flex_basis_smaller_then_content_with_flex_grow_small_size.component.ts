...
@Component({
  ...
  template: `
  <ActionBar title="flex_basis_smaller_then_content_with_flex_grow_small_size"></ActionBar>
  <TSCView id="test-root" style="flex-direction: row; width: 10dip;" backgroundColor="red">
...
export class FlexBasisSmallerThenContentWithFlexGrowSmallSizeComponent {}
