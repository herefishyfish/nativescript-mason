...
@Component({
  ...
  template: `
  <ActionBar title="grid_margins_fixed_stretch"></ActionBar>
  ...
  <TSCView style="height:20dip;width:20dip;margin: 1dip 2dip 3dip 4dip;align-self:stretch;justify-self:stretch;" backgroundColor="green"></TSCView>
...
export class GridMarginsFixedStretchComponent {}
