...
@Component({
  ...
  <TSCView id="test-root" style="display: grid; grid-template-columns: 40dip minmax(0dip, min-content) 40dip;grid-template-rows: 40dip 40dip 40dip" backgroundColor="red">
