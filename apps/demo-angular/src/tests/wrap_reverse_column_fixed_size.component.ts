...
@Component({
  ...
  template: `
    ...
    <TSCView id="test-root" style="width: 200dip; height: 100dip; flex-direction: column; flex-wrap: wrap-reverse; align-items: center;" testID="test-root" backgroundColor="red">
