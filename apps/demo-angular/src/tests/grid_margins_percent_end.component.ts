...
@Component({
  ...
  template: `
    <ActionBar title="grid_margins_percent_end"></ActionBar>
    <TSCView id="test-root" style="display: grid; grid-template-columns: 20dip 20dip 20dip;grid-template-rows: 40dip 40dip 40dip;" testID="test-root" backgroundColor="red">
      <TSCView style="height:20dip;width:20dip;margin: 5% 10% 15% 20%;align-self:end;justify-self:end;" backgroundColor="green"></TSCView>
...
export class GridMarginsPercentEndComponent {}
