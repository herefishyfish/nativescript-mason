...
@Component({
  ...
  template: `
    <ActionBar title="wrap_column"></ActionBar>
    <TSCView id="test-root" style="width: 100dip; height: 100dip; flex-wrap: wrap; flex-direction: column;" testID="test-root" backgroundColor="red">
...
export class WrapColumnComponent {}
